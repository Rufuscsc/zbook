...
const AddBook = ()=>{
    return(
        <div className="py-5 min-h-screen px-4 bg-white md:bg-amber-50">
            <h1 className="text-5xl! md:text-3xl font-bold text-center mx-auto text-foreground">Add a New Books</h1>
